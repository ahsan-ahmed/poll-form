...
const Stepper = ({ pollData, currentIndex, setCurrentIndex, handleSnackbarClick }: IStepperProps) => {
        ...
        <div className="absolute top-1/2 left-20 transform -translate-x-1/2 -translate-y-1/2 flex flex-col">
            ...
            <button
                ...
                onClick={() => {
                    ...
                    !filteredAnswer.length ? setCurrentIndex(pollData?.length) : handleSnackbarClick()
                }}
            />
